describe("Reviews on product page", ()=>{
    ...
    it("validate that the user can submit a review on the product page" , ()=>{
        ...
        cy.get(".action.submit.primary").should("contain",'Submit Review')                                                             // assertion on the Submit Review button
        ...
        cy.get(".actions-primary").click()                                                                                // click on submit review button 
